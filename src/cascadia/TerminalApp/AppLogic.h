...
namespace winrt::TerminalApp::implementation
{
    ...
    private:
        ...
        // This event will be forwarded to the TerminalPage, but we need it to exist
        // before we create the page (as the creation of the page may trigger it!)
        TYPED_EVENT(SetTitleBarContent, winrt::Windows::Foundation::IInspectable, winrt::Windows::UI::Xaml::UIElement);
